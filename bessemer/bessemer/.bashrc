...
export nnUNet_preprocessed="/mnt/parscratch/users/acs23yz/MedNext/nnUNet_preprocessed"
export RESULTS_FOLDER="/mnt/parscratch/users/acs23yz/MedNext/nnUNet_trained_models"

export TORCH_HOME=/mnt/parscratch/users/acs23yz/pytorch
# export TRANSFORMERS_CACHE=/mnt/parscratch/users/acs23yz/huggingface
export HF_HOME=/mnt/parscratch/users/acs23yz/huggingface
