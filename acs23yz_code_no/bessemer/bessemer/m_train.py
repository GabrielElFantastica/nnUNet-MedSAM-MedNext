...
from convert import convert_model_modalities
...
tr_dataset = NpyDataset("data/npy/all_Brain")
...
for step, (image, gt, bboxes, names_temp) in enumerate(tr_dataloader):
    ...
    img_to_show = image[idx, modality_idx].cpu().permute(1, 2, 0).numpy()
...
def main():
    ...
    medsam_model = convert_model_modalities(medsam_model, num_channels=4).to(device)
    medsam_model.train()
