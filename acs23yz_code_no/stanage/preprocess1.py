...
modality = "1"
anatomy = "Lung"  # anantomy + dataset name
img_name_suffix = ".nii.gz"
gt_name_suffix = ".nii.gz"
prefix = modality + "_" + anatomy + "_"

nii_path = "data/Task06_Lung/imagesTr/"  # path to the nii images
gt_path = "data/Task06_Lung/labelsTr"  # path to the ground truth
...
WINDOW_LEVEL = -600  # for Lung images
WINDOW_WIDTH = 1500  # for Lung images
