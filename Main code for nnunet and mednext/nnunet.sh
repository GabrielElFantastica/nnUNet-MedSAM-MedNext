...
# attack
nnUNetv2_predict -d Dataset001_BrainTumour -i /mnt/fastdata/acs23yz/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Dataset001_BrainTumour/imagesTs/ -o /mnt/fastdata/acs23yz/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Dataset001_BrainTumour/inferTs -f  0 -tr nnUNetTrainer -c 3d_fullres -p nnUNetPlans

declare -A datasets_dict
datasets_dict=(["1"]="1_BrainTumour" ["6"]="6_Lung")
i=1
eval_dir="/mnt/fastdata/acs23yz/nnUNetFrame/DATASET/nnUNet_raw/nnUNet_raw_data/Dataset00${datasets_dict[$i]}/inferTs"
